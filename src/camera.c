...
/*   Updated: 2020/11/16 14:09:56 by zjamali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
					...
					double x, double y)
{
	...
	vbs.l.x = vbs.c.x - vbs.u.x * vbs.viewPlaneHalfWidth / 2 - vbs.v.x *
	vbs.viewPlaneHalfHeight / 2;
	vbs.l.y = vbs.c.y - vbs.u.y * vbs.viewPlaneHalfWidth / 2 - vbs.v.y *
	vbs.viewPlaneHalfHeight / 2;
	vbs.l.z = vbs.c.z - vbs.u.z * vbs.viewPlaneHalfWidth / 2 - vbs.v.z *
	vbs.viewPlaneHalfHeight / 2;
	cast_ray.x = vbs.l.x + vbs.u.x * x * vbs.viewPlaneHalfWidth / vbs.W +
	vbs.v.x * y * vbs.viewPlaneHalfHeight / vbs.H;
	cast_ray.y = vbs.l.y + vbs.u.y * x * vbs.viewPlaneHalfWidth / vbs.W +
	vbs.v.y * y * vbs.viewPlaneHalfHeight / vbs.H;
	cast_ray.z = vbs.l.z + vbs.u.z * x * vbs.viewPlaneHalfWidth / vbs.W +
	vbs.v.z * y * vbs.viewPlaneHalfHeight / vbs.H;
	return (cast_ray);
}
