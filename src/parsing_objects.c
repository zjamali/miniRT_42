...
/*   Updated: 2020/11/16 19:58:37 by zjamali          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		parsing_triangle(char **tr, t_scene *scene)
{
	...
	if (tr[4] == NULL)
		ft_print_error("you have to specify 3 trangle points and its color.");
...
void		parsing_cylinder(char **cy, t_scene *scene)
{
	...
	if (cy[5] == NULL)
		ft_print_error("you have to specify cylinder coordination points\
